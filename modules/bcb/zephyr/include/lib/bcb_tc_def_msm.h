...
typedef struct bcb_msm_config {
	...
	uint32_t rec_reset_timeout_ms; /**< Recovery reset timeout in milliseconds. */
	uint32_t rec_reset_timeout_min_ms; /**< Recovery reset timeout minimum in milliseconds. */
	uint32_t rec_reset_timeout_max_ms; /**< Recovery reset timeout maximum in milliseconds. */
